...
class MimeMagic
  ...
  EXTENSIONS = {
    ...
    'asc' => ['application/pgp-encrypted','application/pgp-keys','application/pgp-signature','text/plain'],
    ...
    'blend' => ['application/x-blender','application/x-blender'],
    'blender' => ['application/x-blender'],
    'bmp' => ['image/bmp'],
    'bz' => ['application/x-bzip'],
    'bz2' => ['application/x-bzip'],
    'c' => ['text/x-c++src','text/x-csrc'],
    'c++' => ['text/x-c++src'],
    ...
    'dot' => ['application/msword-template','text/vnd.graphviz'],
    ...
    'gpg' => ['application/pgp-encrypted','application/pgp-keys','application/pgp-signature'],
    ...
    'iso' => ['application/x-cd-image','application/x-wii-rom','application/x-gamecube-rom'],
    ...
    'jpx' => ['application/x-jbuilder-project','image/jp2'],
    ...
    'kexi' => ['application/x-kexiproject-sqlite2','application/x-kexiproject-sqlite3'],
    ...
    'm' => ['text/x-objcsrc','text/x-matlab'],
    'm15' => ['audio/x-mod'],
    'm1u' => ['video/vnd.mpegurl'],
    'm2t' => ['video/mp2t'],
    'm2ts' => ['video/mp2t'],
    'm3u' => ['audio/x-mpegurl','application/vnd.apple.mpegurl'],
    'm3u8' => ['audio/x-mpegurl','application/vnd.apple.mpegurl'],
    'm4' => ['application/x-m4'],
    'm4a' => ['audio/mp4'],
    'm4b' => ['audio/x-m4b'],
    ...
    'oga' => ['audio/ogg','audio/x-vorbis+ogg','audio/x-flac+ogg','audio/x-speex+ogg'],
    'ogg' => ['audio/ogg','video/ogg','audio/x-vorbis+ogg','audio/x-flac+ogg','audio/x-speex+ogg','video/x-theora+ogg'],
    'ogm' => ['video/x-ogm+ogg'],
    'ogv' => ['video/ogg'],
    'ogx' => ['application/ogg'],
    ...
    'otf' => ['application/vnd.oasis.opendocument.formula-template','application/x-font-otf'],
    ...
    'par2' => ['application/x-par2','application/x-par2'],
    'pas' => ['text/x-pascal'],
    'patch' => ['text/x-patch'],
    ...
    'pcf' => ['application/x-font-pcf','application/x-cisco-vpn-settings'],
    'pcf.gz' => ['application/x-font-pcf'],
    'pcf.z' => ['application/x-font-pcf'],
    'pcl' => ['application/vnd.hp-pcl'],
    'pct' => ['image/x-pict'],
    'pcx' => ['image/x-pcx'],
    'pdb' => ['application/x-aportisdoc','application/vnd.palm'],
    ...
    'pl' => ['application/x-perl','application/x-perl'],
    'pla' => ['audio/x-iriver-pla'],
    'pln' => ['application/x-planperfect'],
    'pls' => ['audio/x-scpls'],
    'pm' => ['application/x-perl'],
    'png' => ['image/png','image/x-apple-ios-png'],
    'pnm' => ['image/x-portable-anymap'],
    'pntg' => ['image/x-macpaint'],
    'po' => ['text/x-gettext-translation'],
    'pod' => ['application/x-perl'],
    'por' => ['application/x-spss-por'],
    'pot' => ['application/vnd.ms-powerpoint','text/x-gettext-translation-template'],
    ...
    'prc' => ['application/x-mobipocket-ebook','application/vnd.palm'],
    ...
    'sdp' => ['application/vnd.stardivision.impress','application/sdp'],
    ...
    'smi' => ['application/smil','application/x-sami'],
    ...
    'sty' => ['text/x-tex'],
    'sub' => ['text/x-microdvd','text/x-mpsub','text/x-subviewer'],
    ...
    't' => ['application/x-perl','text/troff'],
    't2t' => ['text/x-txt2tags'],
    ...
    'wks' => ['application/vnd.lotus-1-2-3','application/vnd.ms-works'],
    'wma' => ['audio/x-ms-wma'],
    'wmf' => ['image/x-wmf'],
